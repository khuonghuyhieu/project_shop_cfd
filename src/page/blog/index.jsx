							...
							<div className="card mb-7">
								...
								<div className="card-body px-0">
									...
									<p className="mb-0 text-gray-500">
										...
										over gathered, grass face one every light of under.
									</p>
									{/* Button */}
							...
							<div className="card mb-7">
								...
								<div className="card-body px-0">
									...
									<p className="mb-0 text-gray-500">
										...
										it moveth man replenish. Meat place is so fruit.
									</p>
									{/* Button */}
									<a className="btn btn-link stretched-link px-0 text-reset" href="blog-post.html">
										Read More <i className="fe fe-arrow-right ml-2" />
						...
						<div className="col-12 col-md-6">
							...
							<div className="card mb-7">
								...
								<div className="card-body px-0">
									...
									{/* Text */}
									<p className="mb-0 text-gray-500">
										Let meat subdue the first for fourth is. Them our meat isn't you'll, you're
										place Years dominion shall from years a hath Good appear yielding.
									</p>
									{/* Button */}
									<a className="btn btn-link stretched-link px-0 text-reset" href="blog-post.html">
										Read More <i className="fe fe-arrow-right ml-2" />
