									...
									<div className="row">
										...
										<div className="col-12 col-md">
											...
											<p className="text-gray-500">
												...
												diam sociis. Taciti lobortis nascetur. Ante laoreet odio hendrerit. Dictumst
												curabitur nascetur lectus potenti dis sollicitudin habitant quis vestibulum.
											</p>
											{/* Footer */}
											<div className="row align-items-center">
								...
								<div className="review-body">
									<div className="row">
										...
										<div className="col-12 col-md">
											...
											{/* Title */}
											<p className="mb-2 font-size-lg font-weight-bold">Cute, but too small</p>
											{/* Text */}
											<p className="text-gray-500">
									...
									<div className="review-body">
										...
										<div className="row">
											...
											<div className="col-12 col-md">
												...
												{/* Title */}
												<p className="mb-2 font-size-lg font-weight-bold">Very good</p>
												{/* Text */}
												<p className="text-gray-500">
