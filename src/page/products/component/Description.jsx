										...
										<div className="row">
											<div className="col-12">
												...
												<p className="text-gray-500">
													...
													every. Man subdue rule after years herb after form. And image may,
													morning. Behold in tree day sea that together cattle whose. Fifth
													gathering brought bearing. Abundantly creeping whose. Beginning form have
													void two. A whose.
												</p>
											</div>
											...
											<table className="table table-bordered table-sm table-hover">
												...
												<tbody>
													...
													<tr>
														<td>Free Shipping</td>
														<td>
															Living won't the He one every subdue meat replenish face was you
															morning firmament darkness.
														</td>
														<td>$0.00</td>
													</tr>
												</tbody>
